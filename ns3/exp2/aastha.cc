...
main (int argc, char *argv[])
{
  ...
  p2p1.SetChannelAttribute ("Delay", StringValue ("200ms"));
 
  PointToPointHelper p2p2;
  p2p2.SetDeviceAttribute ("DataRate", StringValue ("12Mbps"));
  p2p2.SetChannelAttribute ("Delay", StringValue ("400ms"));
  ...
  app->Setup (ns3TcpSocket, sinkAddress, 1040, 10000, DataRate ("2Mbps"));
  ...
  app1->Setup (ns3TcpSocket1, sinkAddress1, 1040, 10000, DataRate ("2Mbps"));
  nodes.Get (2)->AddApplication (app1);
  app1->SetStartTime (Seconds (1.));
  app1->SetStopTime (Seconds (100.));

  AsciiTraceHelper asciiTraceHelper;
  Ptr<OutputStreamWrapper> stream = asciiTraceHelper.CreateFileStream ("aastha1.cwnd");
  ns3TcpSocket->TraceConnectWithoutContext ("CongestionWindow", MakeBoundCallback (&CwndChange, stream));
  Ptr<OutputStreamWrapper> stream1 = asciiTraceHelper.CreateFileStream ("aastha2.cwnd");
  ns3TcpSocket1->TraceConnectWithoutContext ("CongestionWindow", MakeBoundCallback (&CwndChange, stream1));

  PcapHelper pcapHelper;
  Ptr<PcapFileWrapper> file = pcapHelper.CreateFile ("aastha.pcap", std::ios::out, PcapHelper::DLT_PPP);
...
//for data file
  ...
  p2p1.EnablePcapAll("aastha1");
  p2p2.EnablePcapAll("aastha2");
