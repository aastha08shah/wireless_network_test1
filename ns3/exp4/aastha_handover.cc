...
main (int argc, char *argv[])
{
  ...
  ifTraceFile.open ("../../src/lte/model/fading-traces/fading_trace_EPA_60kmph.fad", std::ifstream::in);
  if (ifTraceFile.good ())
   {
       //script launched by test.py
      lteHelper->SetFadingModelAttribute ("TraceFilename", StringValue ("../../src/lte/model/fading-traces/fading_trace_EPA_60kmph.fad"));
    }
 else
    {
 ...
 rlcStats-> SetAttribute ("DlRlcOutputFilename", StringValue ("DLRLCAastha1.txt"));
 rlcStats-> SetAttribute ("UlRlcOutputFilename", StringValue ("ULRLCAastha1.txt"));
